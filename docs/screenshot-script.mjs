...
if (!PASS) {
  console.error("set PANEL_PASS env var (e.g. PANEL_PASS=... node docs/screenshot-script.mjs)");
  process.exit(1);
}
...
const SHOTS = [
  ...
  { path: "/servers/forja-a-3?tab=properties", file: "08-properties-editor.png", wait: 1500 },
...
for (const shot of SHOTS) {
  ...
  try {
    ...
    await page.goto(PANEL_URL + shot.path, { waitUntil: shot.wait === "networkidle" ? "networkidle" : "load", timeout: 30000 });
