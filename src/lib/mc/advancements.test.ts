...
describe('prettyAdvancementName', () => {
  ...
  it('drops the prefix and earlier path segments', () => {
    expect(prettyAdvancementName('minecraft:husbandry/breed_all_animals')).toBe(
      'Breed All Animals'
    );
  });
});
...
describe('summarizeAdvancements', () => {
  const raw = {
    'minecraft:story/root': {
      ...
      criteria: { in_overworld: '2026-01-01 10:00:00 +0000' }
    },
    ...
    'minecraft:nether/root': {
      ...
      criteria: { entered_nether: '2026-01-03 09:30:00 +0000' }
    },
    'minecraft:end/root': { done: false, criteria: {} },
    'minecraft:recipes/misc/charcoal': {
      done: true,
      criteria: { has_log: '2026-01-04 08:00:00 +0000' }
    },
    DataVersion: 3700
  };
