...
export const contentMessages: Dict = {
  ...
  "content.mods.modpackInstalled": "modpack instalado: {installed} mods ({errors} errores). MC {mcVersion} + {loader}. Reinicia el servidor.",
  ...
  "content.files.editor.truncated": "⚠ archivo grande (truncado en 1MB). guardar sobrescribirá solo lo que se ve aquí.",
  ...
  "content.backups.list.restoringHint": "restaurando... esto puede tardar unos minutos para backups grandes. no cierres la página.",

  "content.backups.confirmDelete": "¿Eliminar el backup del {date}?",
  "content.backups.confirmRestore": "Restaurar este backup SOBRESCRIBIRÁ el mundo actual. ¿Continuar?",
