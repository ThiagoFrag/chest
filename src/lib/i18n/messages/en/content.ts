...
export const contentMessages: Dict = {
  ...
  "content.mods.installingModpack": "installing modpack \"{title}\" (this may take a while)...",
  "content.mods.modpackInstalled": "modpack installed: {installed} mods ({errors} errors). MC {mcVersion} + {loader}. Restart the server.",
  ...
  "content.files.editor.truncated": "⚠ large file (truncated at 1MB). saving will overwrite only what's shown here.",
  ...
  "content.backups.list.restoringHint": "restoring... this can take a few minutes for large backups. don't close the page.",

  "content.backups.confirmDelete": "Delete backup from {date}?",
  "content.backups.confirmRestore": "Restoring this backup will OVERWRITE the current world. Continue?",
