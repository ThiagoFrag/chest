...
export const adminMessages: Dict = {
  ...
  'admin.settings.drasl.desc': 'Self-hosted auth server so players without a Microsoft account can join',
  'admin.settings.drasl.url.label': 'Drasl URL',
  'admin.settings.drasl.url.help': 'Base URL of your Drasl. The wizard will offer a "use Drasl" toggle once configured.',
  ...
  'admin.settings.cloudflare.desc': 'To create DNS automatically when exposing a server publicly',
  ...
  'admin.settings.cloudflare.zoneId.help': 'Visible on the CF dashboard in the right sidebar of the zone',
  'admin.settings.cloudflare.cnameTarget.label': 'CNAME target',
  'admin.settings.cloudflare.cnameTarget.help': 'Hostname the created subdomains will point to (e.g. the server\'s A record host)',
  ...
  'admin.settings.playit.secretKey.help': 'Create it at playit.gg/account/agents → Self managed (Docker)',
  ...
  'admin.settings.discord.webhookUrl.help': 'for simple notifications (server up/down, backup, crash)',
  'admin.settings.discord.botToken.label': 'Bot Token (MC ⇄ Discord chat bridge)',
  'admin.settings.discord.botToken.help': 'Create a bot at discord.com/developers/applications → Bot → token. Permissions: Send Messages, View Channel, Manage Webhooks. Invite it with the bot scope.',
  'admin.settings.discord.adminUserId.label': 'Your Discord User ID (admin)',
  'admin.settings.discord.adminUserId.help': 'to get a DM when a server crashes. Enable Developer Mode in Discord → right-click your name → Copy User ID.',
  'admin.settings.discord.oauthClientId.label': 'OAuth Client ID (login with Discord)',
  'admin.settings.discord.oauthClientId.help': 'discord.com/developers/applications → your app → OAuth2 → Client ID. Enables "sign in with Discord" and account linking.',
  'admin.settings.discord.oauthClientSecret.label': 'OAuth Client Secret',
  'admin.settings.discord.oauthClientSecret.help': 'OAuth2 → Client Secret. Keep it secret — it is encrypted in the database.',
  'admin.settings.discord.oauthGuildId.label': 'OAuth Guild ID (optional)',
  'admin.settings.discord.oauthGuildId.help': 'Optional. If set, members of this Discord server can create an account automatically (as viewer). Empty = manual linking only.',
  ...
  'admin.settings.chest.mcHost.help': 'Hostname/IP of the Docker host. Shown in "HOW TO CONNECT" on each server\'s overview. IPv6 in brackets.',

  'admin.settings.storage.title': 'STORAGE',
  'admin.settings.storage.desc': 'Where to store backups — local (FS) or S3-compatible (AWS/R2/B2/MinIO)',
  ...
  'admin.settings.storage.s3Endpoint.label': 'S3 endpoint (empty = AWS; R2: https://accountid.r2.cloudflarestorage.com)',
  ...
  'admin.settings.discord.redirect.title': 'ℹ Redirect URI (register it in the Discord Developer Portal)',
  ...
  'admin.settings.bot.addHint': 'opens Discord OAuth in a new tab. you must be a server admin.',

  // settings - discord guided flow
  'admin.settings.discord.flow.title': 'DISCORD',
  'admin.settings.discord.flow.desc': 'connect the bot in 3 steps. self-hosted, so the token is yours.',

  'admin.settings.discord.step1.title': '1. Connect the bot',
  'admin.settings.discord.step1.desc': 'paste your bot token and validate it before saving.',
  ...
  'admin.settings.discord.step1.helpBody': 'create an application, open the Bot tab and copy the token.',
  'admin.settings.discord.step1.helpLink': 'Discord Developer Portal',

  'admin.settings.discord.step2.title': '2. Add it to your server',
  'admin.settings.discord.step2.desc': 'you will pick which server to add it to, right on the Discord screen.',
  ...
  'admin.settings.discord.step2.locked': 'validate or save a valid token in step 1 to unlock.',

  'admin.settings.discord.step3.title': '3. Status',
  'admin.settings.discord.step3.channelNote': 'which channel each server uses is set in that server\'s Discord tab (DiscordBridgePanel). no need to configure it here.',

  'admin.settings.discord.advanced.summary': 'Advanced',
  'admin.settings.discord.advanced.webhookLabel': 'Webhook URL (legacy)',
  'admin.settings.discord.advanced.webhookHelp': 'Optional. Simple notifications (server up/down/crash) WITHOUT running the bot 24/7. If you already use the bot above, you don\'t need this.',
  'admin.settings.discord.advanced.adminIdHelp': 'Optional. Gets a DM when a server crashes.',
  'admin.settings.discord.advanced.loginTitle': 'Login with Discord',
  'admin.settings.discord.advanced.loginDesc': 'OAuth for "sign in with Discord". A separate feature, independent of the bot.',

  // webhooks
  'admin.webhooks.head': 'Chest · Webhooks',
  'admin.webhooks.title': 'WEBHOOKS',
  'admin.webhooks.subtitle': 'notify external systems when events happen (Slack, n8n, Zapier, etc)',
  'admin.webhooks.errorGeneric': 'failed',
  'admin.webhooks.errorStatus': 'error {status}',
  'admin.webhooks.secretCreated': '✓ webhook created! Save the secret — it is shown only once:',
  ...
  'admin.webhooks.docs.compare': 'compare it with the HMAC SHA-256 of the raw body using the secret:',
  ...
  'admin.security.confirmDisable': 'Are you sure? This removes 2FA protection from your account.',
  'admin.security.totp.title': '2FA AUTHENTICATION (TOTP)',
  'admin.security.totp.desc': '6-digit code from your authenticator app (Google Authenticator, Authy, Aegis, 1Password)',
  'admin.security.totp.active': 'active',
  'admin.security.totp.inactive': 'disabled',
  'admin.security.backup.saved': '✓ 2FA ENABLED! Save these backup codes in a safe place:',
  'admin.security.backup.copyAll': 'copy all',
  'admin.security.backup.noted': 'got it',
  'admin.security.backup.onceHint': '⚠ each code can be used once. they replace the app code if you lose access to your authenticator.',
  ...
  'admin.security.intro': 'adding 2FA makes your account much safer. even if someone learns your password, they can\'t get in without the app code.',
  ...
  'admin.users.role.operatorDesc': 'manage existing servers (start/stop, console, mods, backups)',
