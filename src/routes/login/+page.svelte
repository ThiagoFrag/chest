    ...
    {#if data.discordEnabled}
      {#if data.discordError}
        <p class="mt-4 text-sm text-destructive" style="text-shadow: 2px 2px 0 #3f3f3f;">
          ⚠ Não foi possível entrar com Discord: {data.discordError}
        </p>
      {/if}

      <div class="mc-divider mt-4" style="text-shadow: 2px 2px 0 #3f3f3f;">ou</div>

      <a
        href="/login/discord"
        class="mc-btn mc-btn-discord w-full mt-4 text-base"
        aria-label="Continuar com Discord"
